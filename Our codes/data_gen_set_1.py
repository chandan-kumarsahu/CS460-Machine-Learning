...
ms=[0.1, 0.2]
star_mass_files = ['ms_0.1', 'ms_0.2']
a=[0.01, 0.05]
a_files = ['a_0.01', 'a_0.05']
mp=[0.5, 1.0]
rp=[0.88, 1.05, 0.88, 1.05]
mass_radius_planet_files = ['mp_0.5_rp_0.88', 'mp_0.5_rp_1.05', 'mp_1.0_rp_0.88', 'mp_1.0_rp_1.05']
wm=[0.5, 1.0]
water_mass_files = ['wm_0.5', 'wm_1.0']

'''


path='/home/ws1/ML/DATASET/'
...
# run the files
dir_path=r'/home/ws1/ML/DATASET/'
# Iterate directory
